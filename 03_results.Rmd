...
A total of 438 specimens comprising `r count.males` males and `r count.females` females were evaluated for this study from three different surveys (Table \@ref(tab:table2)).  The post orbital head length (L~PO~) measurement had a lower number of measurements compared to other methods because it was abandoned after measuring 130 Sablefish due to technical issues.  The smallest fork length of the collected specimens was `r fish.min` mm, the largest was `r fish.max` mm, and the average was `r round(fish.avg,1)` mm.  This range of sizes are broadly representative of those found in the fishery and survey.
...
The 360 heads received from the commercial vessel were in good condition and operculum cuts worked well to indicate sex. The first 99 heads (`r count99[1]` from Cobb Seamount, `r count99[2]` from Eikelberg seamount) were measured once by three expert science technicians for each cranial dimension of L~UJ~, L~ID~, L~SL~ and L~PP~ (Table \@ref(tab:table5)).  The cranial measurements that produced the lowest mean error were upper jaw (L~UJ~) and interorbial distance (L~ID~) with IAE values of `r IAE.UJ` % and `r IAE.ID` %, respectively (Table \@ref(tab:table5)). Genomic DNA (80 of 99 fin clips collected) were successfully PCR amplified resulting in an accuracy reported by the MGL at 83.8% (67/80) for commercial fisher sex detection.
