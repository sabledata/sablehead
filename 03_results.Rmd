...
A total of 438 specimens comprising `r count.males` males and `r count.females` females were evaluated for this study from three different surveys ((Table \@ref(tab:table3))).  The post orbital head length (L~PO~) measurement had a lower number of measurements compared to other methods because it was abandoned after testing 130 sablefish. Technicians doing the measurements noted technical issues with this approach.  The smallest fork length of the collected specimens was `r fish.min` mm, the largest was `r fish.max` mm, and the average was `r round(fish.avg,1)` mm. 
