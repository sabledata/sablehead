...
a predictors of the fork length  (L~FL~) for 438 Sablefish collected from research surveys in 2016. Cranial lengths included: 
...
```{r table5, echo=FALSE}
   ...
   samples.data <- read.csv(paste(path,'export.samples.csv',sep=''),header=T) # Read csv created in index.rmd
...
#  separate out by sampler
   ...
   kableExtra::kable(pilot.table, 
                     booktabs = TRUE, col.names = c("Head Dimension", "Min - Max (mm)", "Min - Max (mm)","Min - Max (mm)", "IAE"), 
                     linesep = "",
                     escape = F, 
                     align = c("l","c","c","c","l"),
