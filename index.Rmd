...
author: |
  Lisa. C. Lacko^1^ and
  Kathryn L. Temple^1^ and
  Kendra R. Holt^1^ and
  Janine K. Supernault^1^ and
  Kronlund, A. R.^2^ and
  Malcolm R. Wyeth^1^ and 
  Brendan M. Conners^1^
author_list: "Lacko, L.C., Temple, K.L., Holt, K.R., Supernault, J.K.,Kronlund, A.R., Wyeth, M.R, and Conners, B.M."
...
address: |
  ^1^Pacific Biological Station\
     ...
     \
  ^2^Interface Fisheries Consulting, Ltd.\
