...
```{r figure1, fig.cap='(ref:figure1)',warning=FALSE, echo=FALSE, message=FALSE, error= FALSE, width=5.5, height=5.0,fig.align='center'}

    png("C:/github/sablehead/figures/Figure1.png",  width = 480, height = 630, units = "px") # write png to file
...
```{r figure2, fig.cap='(ref:figure2)', results='asis',echo=FALSE,fig.height = 8, fig.width = 8,  fig.align = "center"} 
   ...
   ggplot(data.frame(x = 1:3, y = 1:3), aes(x, y)) +
          ...
          #annotation_custom(g,   xmin = 1.7,    xmax = 2.1,   ymin = 2.45,  ymax = 3.2)   +   
          geom_text(x=0.95,  y=2.9, label='Eye Diameter: anterior-posterior diameter of eye socket. ', 
                                           hjust=0, size=3) +  # place fish image
          geom_text(x=0.95,  y=2.8, label='Use the outward-facing points of the calipers . ', 
                                           hjust=0, size=3) +  # place fish image
